...
if ($response != null && $response->success) {
  ...
  .'Como nos conheceu?:'.$_POST['conheceu'].'<br>'
  .'Assunto:'.$_POST['subject'].'<br>'
  .'Mensagem:'.$_POST['message'].'<br>'
);
  $mail->AltBody = 'This is a plain-text message body';
  if (!$mail->send()) {
    echo "<script type='text/javascript'> document.location = 'contact.html?email=error'; </script>";
  } else {
    echo "<script type='text/javascript'> document.location = 'contact.html?email=success'; </script>";
  }
